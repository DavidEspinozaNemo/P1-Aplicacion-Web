<%-- 
    Document   : newjsp
    Created on : 23 mar 2023, 19:23:18
    Author     : keylo
--%>
        ...
        <form>
            ...
            <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="apellido1" placeholder="Martin">
              </div>

              <div class="form-group col-md-6">
                <label for="text">Apellido 2: </label>
                <input type="text" class="form-control" id="apellido2" placeholder="Martin">
              </div>
